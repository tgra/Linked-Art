...
| -------- | ------------- | ------------- | ------- | ------ |
| Collections Data | Indianapolis Museum of Art - selected artwork  |  [download](./jupyter_notebooks/Transforming_Collections_to_Linked_Art_IMA.ipynb) | [nbviewer](https://nbviewer.org/github/tgra/Linked-Art/blob/main/jupyter_notebooks/Transforming_Collections_to_Linked_Art_IMA.ipynb) | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/tgra/Linked-Art/HEAD?labpath=jupyter_notebooks%2FTransforming_Collections_to_Linked_Art_IMA.ipynb)|
...
| Collections Data| Clevland Museum of Art | [download](./jupyter_notebooks/Transforming_Collections_Data_to_Linked_Art_CMA.ipynb) | [nbviewer](https://nbviewer.org/github/tgra/Linked-Art/blob/main/jupyter_notebooks/Transforming_Collections_Data_to_Linked_Art_CMA.ipynb) | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/tgra/Linked-Art/HEAD?labpath=jupyter_notebooks%2FTransforming_Collections_Data_to_Linked_Art_CMA.ipynb) |
