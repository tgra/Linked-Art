...
| -------- | ------------- | ------------- | ------- | ------ |
| Transform | Indianapolis Museum of Art  |  [download]([[01-07-Transform-XML-IMA.ipynb](http://localhost:8888/notebooks/01-07-Transform-XML-IMA.ipynb)](http://localhost:8888/notebooks/01-07-Transform-XML-IMA.ipynb)) | [nbviewer](https://nbviewer.org/github/tgra/Linked-Art/blob/main/01-07-Transform-XML-IMA.ipynb) | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/tgra/Linked-Art/HEAD?labpath=01-07-Transform-XML-IMA.ipynb)|
